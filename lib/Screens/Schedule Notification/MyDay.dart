...
class _ReminderState extends State<Reminder> {
  ...
  TextEditingController _textEditingController =
      TextEditingController(text: "Reminder Content");
  ...
  Future<void> onCreate() async {
    if (_textEditingController.length != 0) {
      ...
      await Fluttertoast.showToast(
          msg: "Pls Enter Reminder Content",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        padding: const EdgeInsets.symmetric(horizontal: 14.0, vertical: 44),
        child: Padding(
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  suffix: Container(
                    ...
                    child: Text(
                        (maxTitleLength - _textEditingController.text.length)
                            .toString()),
                  ),
                ),
              ),
